        ...
        <FlexContainerColumnGapped $alignitems="flex-start">
          <DescriptionSection>
            ...
            <ul className="event-ul">
              <li>
                <b>Understanding AI:</b> Our host, Oforiwaa, began by
                simplifying AI, defining it as technology that enables machines
                to perform tasks that typically require human intelligence.
                Oforiwaa also provided examples of how AI is being applied in
                our daily lives, such as virtual assistants like Siri, and in
                robotics with creations like Pepper and Sophia. Additionally,
                she highlighted how AI is utilized in mundane tasks such as
                email management, showcasing its pervasive presence in our
                modern world.
              </li>
              <li>
            ...
            <div>
              <iframe
                width="640"
                height="360"
                src="https://www.youtube.com/embed/KoWJTIfPPhU?si=TQUaNoPCLqKCz-5O"
