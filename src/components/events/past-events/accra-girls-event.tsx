...
import banner from "../../../../public/assets/events/Second option~2.png";
    ...
    <EventPage
      ...
      description={
        <Description>
          <h2>Event Summary</h2>
          <p>
            Thank you to all who joined us for an impactfulful event as we
            delved into the world of technology at the{" "}
            <b>Accra Girls&apos; Senior High Outreach</b>.{" "}
            Reflecting on the memorable event held at Accra Girls&apos; Senior High School, 
            it was an enriching experience where we engaged with the young ladies, 
            introducing them to unconventional engineering fields such as cloud engineering
             and artificial intelligence. Accompanied by esteemed lecturers from the
              University of Ghana, we delved into the requirements for engineering courses
               and how to prepare for admission. The highlight was hearing from final-year
                engineering students who shared invaluable insights into navigating both 
                university life and male-dominated fields. The event resonated with three key takeaways: 
          </p>
          <h3>Key Highlights</h3>
          <ul className="event-ul">
            <li>
              <b>Unleash Your potential:</b> We encouraged the girls to break barriers and not confine their aspirations 
            ...
            <li>
              ...
              it is equally vital to supplement learning with practical experiences. 
              Exploring real-life scenarios in one&apos;s field of interest equips individuals 
              with invaluable skills and prepares them for the challenges beyond the classroom.
            </li>
            <li>
              <b>No One is an Island:</b> Recognize the significance of building connections and
               seeking support for the right people. Whether it&apos;s peers, mentors, or industry professionals,
               no one succeeds in isolation. Embracing collaboration
               fosters growth and resilence.
            </li>
          </ul>
          ...
          <p>
            ...
            suggestions, or any feedback you may have regarding the school outreach
             by clicking the button below to complete our feedback
