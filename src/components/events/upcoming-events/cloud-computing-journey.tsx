      ...
      description={
        <FlexContainerColumn style={{ alignItems: 'flex-start' }}>
          ...
          <p>
            ...
            showcase its wide-ranging applications in today's dynamic world.
            Whether you're a tech enthusiast, a budding professional, or simply
            curious about the possibilities Cloud Computing holds, this event is
            your gateway to understanding the present and shaping the future.
          </p>
        </FlexContainerColumn>
      }
    />
