      ...
      description={
        <FlexContainerColumnGapped>
          <p>
            ...
            discovered her enthusiasm for Bioinformatics, Natalie&apos;s
            research bridges Biomedical Science and Computer Science. You
            don&apos;t want to miss out on insightful discussions and answers to
            your burning questions about Bioinformatics. 🥳
          </p>
          <p>
            Step into the exciting world of Clinical Engineering with our new
            series! Let&apos;s embark on a journey,{" "}
            <b>&apos;Exploring Bioinformatics and Beyond&apos;!</b>, where we
            delve deep into the heart of biomedical innovation. Our esteemed
            guest, Natalie Kokroko, will take you on a journey through her
            professional experiences, offering invaluable insights into the
            intricacies of Clinical Engineering.
          </p>
          <p>
